class TreatmentsController < ApplicationController
  ...
  def show
    @observationbiometrics = @treatment.observationbiometrics.all
    @observationbiometric = @treatment.observationbiometrics.build
  end
  ...
  private
    ...
    def treatment_params
      params.require(:treatment).permit(:disease_id, :startdate, :enddate, :totalweeks, :medicine, :dose, :device, :surgery, :treatmentcomplete)
    end
end
