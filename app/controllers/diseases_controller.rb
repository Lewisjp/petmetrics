class DiseasesController < ApplicationController
  ...
  def show
    ...
    @treatment = @disease.treatments.build
  end
  ...
  private
    ...
    def disease_params
      params.require(:disease).permit(:cat_id, :veterinarian, :dateofdiagnosis, :condition, :conditionform, :conditionrelapse, :remission, :remissiondate)
    end
end
