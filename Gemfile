...
# SSH: a pure-Ruby implementation of the SSH2 client protocol. It allows you to write programs that invoke and interact with processes on remote servers, via SSH2.
# Requires further updates to local environment 
gem 'net-ssh', '~> 2.8.0'

# Get font awesome for icons
# references 
