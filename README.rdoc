...
<tt>\Disease and treatment analysed in the prototype\</tt>
...
<tt>\Reason for displaying health trend while on suggested treatment\</tt>
...
<tt>\Integration with Intel® oneAPI\</tt>
