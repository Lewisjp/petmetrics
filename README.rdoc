...
![Prototype State Chart Diagram](https://github.com/Lewisjp/petmetrics/blob/master/app/assets/images/static/StateChartDiagram.png "Prototype State Chart Diagram")


###Prototype Admin Workflow Diagram
![Prototype Admin Workflow Diagram](https://github.com/Lewisjp/petmetrics/blob/master/app/assets/images/static/Prototype.png "Prototype Admin Workflow Diagram")

Most recent CSV export of database information can be found at [petmetrics/public/outgoing/allrecords.csv](https://github.com/Lewisjp/petmetrics/blob/master/public/outgoing/allrecords.csv)
...
Basic script can be seen at [https://github.com/Lewisjp/petmetrics/blob/master/lib/scripts/syncOneAPIandAPP.rb](https://github.com/Lewisjp/petmetrics/blob/master/lib/scripts/syncOneAPIandAPP.rb)
* DevCloud Analytics scripts can be seen on the [Pet Metrics Analytics Git Repo](https://github.com/Lewisjp/petmetricsanalytics)
